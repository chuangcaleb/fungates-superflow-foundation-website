...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_pages_blocks_content_columns_size" ADD VALUE 'halfWide' BEFORE 'twoThirds';
  ALTER TYPE "public"."enum__pages_v_blocks_content_columns_size" ADD VALUE 'halfWide' BEFORE 'twoThirds';`)
}
